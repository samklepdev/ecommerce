...
/** Same render-time re-keying pattern as `VariantPriceEditor`'s
...
/** Always-editable inline cost field, mirroring `VariantPriceEditor` — cost
 * (what the supplier charges) is deliberately independent of the variant's
